...
dft <- getSoilData(DataSets=NULL,observedProperty='6A1', usr='ross.searle@gmail.com', key='eaXxVBG8nrWvrYfz', verbose = T)
...
tomcnts <- as.data.frame(table(dft$Dataset))


sum(is.null(dft$Value))
