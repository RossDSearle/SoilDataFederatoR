...
rawJson <- content(GET('http://esoil.io/TERNLandscapes/SoilDataFederatoR/R/SoilDataAPI/Providers'), "text")
...
df <- fromJSON('http://esoil.io/TERNLandscapes/SoilDataFederatoR/R/SoilDataAPI/Providers')


# Get the Providers data as XML
rawXML <- content(GET('http://esoil.io/TERNLandscapes/SoilDataFederatoR/R/SoilDataAPI/Providers?format=xml'), "text")
...
csvf <- tempfile()
download.file('http://esoil.io/TERNLandscapes/SoilDataFederatoR/R/SoilDataAPI/Providers?format=csv', csvf, mode="wb", quiet = T)
df <- read.csv(csvf)
head(df)
unlink(csvf)
...
url <- 'http://esoil.io/TERNLandscapes/SoilDataFederatoR/R/SoilDataAPI/SoilData?observedProperty=3A1&providers=TasGovernment'
df <- fromJSON(url)
head(df)
