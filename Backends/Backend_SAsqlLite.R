  ...
  for (i in 1:nrow(propRecs)) {
    ...
    if(propertyType==PropertyTypes$LaboratoryMeasurement){
      ...
      if(nrow(fdf) > 0){
        ...
        date <- as.Date(rd, format = "%d/%b/%Y")
        odate <- format(date, format="%d-%m-%Y")
        oOutDF <- generateResponseDF(DataSet, paste0(fdf$id, '_', fdf$site_id), fdf$horizon_id, fdf$horizon_id, odate, fdf$longitude, fdf$latitude, (fdf$`upper_depth:1` * 0.01) , (fdf$`lower_depth:1` * 0.01), propertyType, sProp,fdf$lab_result_value, units)
        lodfs[[i]] <- oOutDF
      }else{
      ...
      tabName <- SAMorphMappings[str_to_upper(SAMorphMappings$ObservedProperty) == str_to_upper(sProp),]$TableName
      tabLev <- as.numeric(SAMorphMappings[str_to_upper(SAMorphMappings$ObservedProperty) == str_to_upper(sProp),]$TabLev)
      ...
      if(tabLev == 4){
        ...
        date <- as.Date(rd, format = "%d/%b/%Y")
        odate <- format(date, format="%d-%m-%Y")
        oOutDF <- generateResponseDF(DataSet, paste0(fdf$id, '_', fdf$site_id), fdf$horizon_id, fdf$horizon_id, odate, fdf$longitude, fdf$latitude, (fdf$upper_depth * 0.01) , (fdf$lower_depth * 0.01), propertyType, sProp, fdf[, 9], units)
        ...
        date <- as.Date(rd, format = "%d/%b/%Y")
        odate <- format(date, format="%d-%m-%Y")
        oOutDF <- generateResponseDF(DataSet, paste0(fdf$id, '_', fdf$site_id), 'NA', 'NA', odate, fdf$longitude, fdf$latitude,  'None' , 'None' , propertyType, sProp, fdf[, 6], units)
...
SAMorphMappings <- structure(list(Dataset = c("SAGovernment","SAGovernment", "SAGovernment", "SAGovernment",
                                              ...
                                              "SAGovernment", "SAGovernment", "SAGovernment", "SAGovernment",
                                              "SAGovernment", "SAGovernment", "SAGovernment", "SAGovernment",
                                              "SAGovernment"), TableName = c("horizons", "coarsefrags", "coarsefrags",
                                                                             ...
                                                                             "sites", "sites", "sites", "sites", "sites"), ObservedProperty = c("h_name", "CF_NO",
                                                                                                                                                ...
                                                                                                                                                "S_PATT_TYPE", "S_REL_MS_CLASS"), OrigPropertyCode = c("horizon", "coarse_frag_no",
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       "pattern_type", "pattern_modal_slope_class"), DataType = c("M", "L",
                                                                                                                                                                                                                                                                  "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L",
                                                                                                                                                                                                                                                                  "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L",
                                                                                                                                                                                                                                                                  "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L",
                                                                                                                                                                                                                                                                  "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L",
                                                                                                                                                                                                                                                                  "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L"), StandardCode = c(FALSE, TRUE,
                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                           TRUE, TRUE), TabLev = c(3L, 4L, 4L, 4L, 4L, 3L, 3L, 3L, 3L, 3L, 3L,
