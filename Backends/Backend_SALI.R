...
ph_Hack <- function(DataSet, observedProperty){
    ...
    sql <- paste0('SELECT SIT.PROJECT_CODE, OBS.SITE_ID, OBS.OBS_NO, OBS.OBS_DATE, OLC.DATUM, OLC.LATITUDE, OLC.LONGITUDE, HOR.HORIZON_NO, HOR.UPPER_DEPTH, HOR.LOWER_DEPTH, FTS.VALUE , FTS.DEPTH, FTS.TEST_NO, FTS.TEST_TYPE
              ...
              WHERE OLC.DATUM="3" and FTS.TEST_TYPE="PH" COLLATE NOCASE;')
