...
#
# 2)	Morphology metadata endpoint
...
# http://asris-daas02/NatSoil_Services/api/MorphResults?morphology_attribute=h_texture

# An example of filtering and paging is:
#   http://asris-daas02/NatSoil_Services/api/MorphResults?morphology_attribute=h_texture&agency_code=180&page_num=1&page_size=10




getData_ASRISHostedAPI <- function(DataSet=NULL, observedProperty=NULL, observedPropertyGroup=NULL ){
